...
Before using this, the loop database needs to be generated by running `generate_loops.py`. (Note: the rna_bits library must first be installed). This might take multiple hours.
```
